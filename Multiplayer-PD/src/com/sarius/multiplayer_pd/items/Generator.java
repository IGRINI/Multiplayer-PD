...
import com.sarius.multiplayer_pd.actors.mobs.npcs.Wandmaker.Rotberry;
import com.sarius.multiplayer_pd.items.armor.*;
import com.sarius.multiplayer_pd.items.artifacts.*;
...
import com.sarius.multiplayer_pd.items.food.Pasty;
import com.sarius.multiplayer_pd.items.potions.*;
import com.sarius.multiplayer_pd.items.rings.*;
import com.sarius.multiplayer_pd.items.scrolls.*;
import com.sarius.multiplayer_pd.items.wands.*;
import com.sarius.multiplayer_pd.items.weapon.*;
import com.sarius.multiplayer_pd.items.weapon.melee.*;
import com.sarius.multiplayer_pd.items.weapon.missiles.*;
import com.sarius.multiplayer_pd.plants.*;
