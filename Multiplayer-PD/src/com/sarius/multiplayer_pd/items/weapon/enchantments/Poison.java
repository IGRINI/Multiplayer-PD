...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.sarius.multiplayer_pd.actors.buffs.Poison.class ).
				set( com.sarius.multiplayer_pd.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
